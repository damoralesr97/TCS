CREATE TABLE public.t_persons (
	...
	per_id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	...
	CONSTRAINT t_persons_per_dni_key UNIQUE (per_dni),
